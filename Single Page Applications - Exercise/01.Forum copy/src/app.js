import { getPosts, postComment, getComments, createTopic } from "./requests";
import { createPostsElement, createCommentsElement} from "./display";
import { isValidData, clearFormFields } from "./helper";
...
document.addEventListener('submit', async e =>{
    ...
    console.log(`Deserialized FormData:  ${deserializedData}`);////////////////////////////////

    const forms = {
        'postForm': async e => {
            if(e.submitted.className = 'public'){
